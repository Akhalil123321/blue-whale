    ...
    <div className='contact-container'>
        ...
        <div className='contact-methods'>
          ...
          <div className='contact-item'>
            ...
            <ul className='social-icons'>
              ...
              <SocialIcon link='https://www.instagram.com/bluewhale.ad/profilecard/?igsh=MXJqMXdtYTJpbDcyeQ==' icon={<FaInstagram />} />
      ...
      <div className='contact-location'>
        ...
        <a 
          ...
          href='https://maps.app.goo.gl/AwMBKKyiNEbFfs2A8?g_st=iw' 
          target='_blank' 
          rel='noreferrer'
        >
          Shining Towers, Khalidiyah, Floor 25, Office 2502
        </a>
      </div>
    </div>
  )
